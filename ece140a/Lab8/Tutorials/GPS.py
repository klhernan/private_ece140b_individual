...
def GPS_Info():
   ...
   lat_in_degrees = convert_to_degrees(lat) if nmea_latitude_dir == 'N' else (convert_to_degrees(lat * -1))  
   #get longitude in degree decimal format with direction
   long_in_degrees = convert_to_degrees(longi) if nmea_latitude_dir == 'E' else (convert_to_degrees(longi * -1))
