...
def index_page(req):
   ...
   # return FileResponse('./Lab3/Tutorial_REST/index.html')
   # return FileResponse(str(cwd) + "/index.html")
...
if __name__ == '__main__':
   with Configurator() as config:
      ...
      #   config.add_static_view(name='/', path='./Lab3/Tutorial_REST' + "/public", cache_max_age=3600)
