...
# Adding brightiness to image
someimage = cv2.normalize(image, image, 50, 255, cv2.NORM_MINMAX)


cv2.imwrite('./test_test.jpg', image) # Write these values to your Pi
...
# window_name = 'image'
# cv2.imshow(window_name, someimage)